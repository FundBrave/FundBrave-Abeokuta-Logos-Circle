...
/**
 * FE-M6: Route-level error boundary for the /donate page.
 * Next.js App Router automatically renders this when an error is thrown
 * inside the donate route segment, isolating it from the rest of the app.
 */
...
export default function DonateError({
  ...
  useEffect(() => {
    if (process.env.NODE_ENV !== "production") {
      console.error("[DonateError]", error);
    }
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-[#09011a] flex items-center justify-center px-4">
      <div className="glass rounded-2xl p-8 max-w-md w-full text-center">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Unable to load donate page</h2>
