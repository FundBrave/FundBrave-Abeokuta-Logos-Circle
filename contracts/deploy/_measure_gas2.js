...
async function main() {
  ...
  console.log("Estimating gas for full lzReceive...");
  try {
    ...
    console.log("Executor limit: 200000");
    console.log("Exceeds limit?", gasEst > 200_000n ? "YES — OUT OF GAS" : "No — gas is sufficient");
  } catch (e) {
    console.log("estimateGas failed:", e.shortMessage || e.message?.slice(0, 250));
  }
}
